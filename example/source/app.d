...
bool not(V)(V v) if(is(typeof(cast(bool)v))) {return !cast(bool)v;}

bool hasValue(NullableType)(NullableType nullableValue)
if(isInstanceOf!(Nullable, NullableType))
{  return !nullableValue.isNull;
}

bool hasValue(FloatingType)(FloatingType nullableValue)
if(isFloatingPoint!(FloatingType))
